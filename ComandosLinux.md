...
ssh-keygen -t ed25519 -c (email) - (Criar chaves publica e privada SSH)

cat (na pasta que foi salva com id da chave publica com .pub)

eval $(ssh-agent -s) - (Para iniciar a ssh keygen)

ssh-add (na pasta .ssh colocar id da chave privada)
...
- chmod
  ...
  **octal arq**
  ...
  , que pode ser especificada separadamente para “usuário”, “grupo” e “outros”. Os valores em octal são representados abaixo:
...
## **Guia de Referência Completo: Comandos Avançados do Terminal GNU/Linux**
